...
if (isset($_POST['submit'])) {
	...
	if (mysqli_num_rows($cek) == 0) {
		$sql = mysqli_query($coneksi, "INSERT INTO sekolah(id_sekolah, nama_sekolah, alamat_sekolah, kepala_sekolah, username, password, logo_sekolah) VALUES('$id_sekolah', '$nama_sekolah', '$alamat_sekolah','$kepala_sekolah', '$username', '$password', '$logo_sekolah')") or die(mysqli_error($coneksi));
		if ($sql) {
