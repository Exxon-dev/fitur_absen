    ...
    <div class="main-container container-custom">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-center mb-3 position-relative" style="width: 100px; height: 100px; margin: auto;">
                <img id="previewFoto" src="http://localhost/fitur_absen/absensi/pages/image/<?php echo $data['profile']; ?>" alt="Foto Prmbimbing" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
