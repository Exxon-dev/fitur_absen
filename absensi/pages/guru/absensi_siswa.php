                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            while ($siswa = mysqli_fetch_assoc($query_siswa)) {
                                // Ambil absensi hari ini untuk siswa
                                $absenQuery = mysqli_query($coneksi, "SELECT keterangan FROM absen WHERE id_siswa = {$siswa['id_siswa']} AND tanggal = '$tanggal'");
                                $absen = mysqli_fetch_assoc($absenQuery);
